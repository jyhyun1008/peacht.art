...
const addAudio = (url, title, index, delay) => {
    ...
    document.getElementsByClassName('tracklist')[0].innerHTML += '<div class="track_title" style="top: '+index*110+'px;">'+title+'</div><div class="track_item" ><canvas class="track_canvas"></canvas></div>';
